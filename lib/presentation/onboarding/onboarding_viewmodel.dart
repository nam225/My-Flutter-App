...
// inputs mean the orders that our VM will receive from our view
mixin OnBoardingViewModelInputs {
  ...
  Sink
      get inputSliderViewObject; // the way to add data to the stream .. stream input
}

// outputs mean data or result that will be sent from our VM to our view
